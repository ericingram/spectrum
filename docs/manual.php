...
function printResult($code, $settings = array())
{
	...
	print '<iframe src="runner.php?code=' . urlencode($code) . '&' . implode('&', $settings) . '" frameborder="0" style="' . $style . '"></iframe>' . "\r\n";
	print '</div>' . "\r\n";
}
?>
...
<p>Скачать исходные коды можно с <a href="https://github.com/mkharitonov/spectrum/">github.com</a></p>
...
<h1>Базовая структура</h1>

<p>Для написание спецификаций Spectrum предоставляет несколько различных <a href="#constructionCommands">команд конструирования</a>. Базовая древовидная
...
<p>Суть контекстов можно продемонстрировать на примере, когда требуется одни и теже it() выполнить в разных мирах (тобишь при разных внешних условиях).</p>
...
<h1>Включение/отключение узлов</h1>
...
<h1 id="constructionCommands">Команды конструирования</h1>
...
<p>В ближайшее время пранируется реализовать следующие нововведения:</p>
<ol>
	<li>
